...
val Icons.Filled.Sort: VectorAsset by lazy {
    materialIcon(name = "iconFilledSorted") {
        materialPath {
            moveTo(3.0f, 18.0f)
...
val Icons.Filled.ArrowForwardIos: VectorAsset by lazy {
    materialIcon(name = "iconFilledArrowForward") {
        materialPath {
            moveTo(5.88f, 4.12f)
            lineTo(13.76f, 12.0f)
...
val Icons.Filled.AttachMoney: VectorAsset by lazy {
    materialIcon(name = "iconFilledAttachMoney") {
        materialPath {
            moveTo(11.8f, 10.9f)
...
val Icons.Filled.MoneyOff: VectorAsset by lazy {
    materialIcon(name ="iconFilledMoneyOff") {
        materialPath {
            moveTo(12.5f, 6.9f)
            curveToRelative(1.78f, 0.0f, 2.44f, 0.85f, 2.5f, 2.1f)
            horizontalLineToRelative(2.21f)
...
val Icons.Filled.PieChart: VectorAsset by lazy {
    materialIcon(name = "iconFilledPieChart") {
        materialPath {
            moveTo(11.0f, 2.0f)
